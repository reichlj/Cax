...
m = input(' Masse : ');
fk = input(' Federkonstante : ');

disp('Anfangsbedingungen ')
x0(1,1)=input(' Auslenkung Masse 1 : ');
x0(2,1)=input(' Auslenkung Masse 2 : ');

v0(1,1)=input(' Geschwindigkeit Masse 1 : ');
v0(2,1)=input(' Geschwindigkeit Masse 2 : ');
...
k = input('Eigenschwingung Nr.: [1...2] ');
